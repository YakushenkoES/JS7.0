...
/***/ "./src/js/modules/PagePartSlider.js":
/*!******************************************!*\
  !*** ./src/js/modules/PagePartSlider.js ***!
  \******************************************/
...
/* harmony import */ var _findMatchesElement__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./findMatchesElement */ "./src/js/modules/findMatchesElement.js");
...
/*#__PURE__*/
function () {
  function PagePartSlider(_containerClass, _partClass) {
    _classCallCheck(this, PagePartSlider);

    this.partClass = _partClass;
    this.page = document.querySelector(".".concat(_containerClass));
    this.btnsDownNext = _toConsumableArray(this.page.querySelectorAll('a.next')); //Array.from(this.page.querySelectorAll('a.next'));//
  ...
  _createClass(PagePartSlider, [{
    ...
    value: function prepare() {
      ...
      this.page.addEventListener('click', function (e) {
        ...
        if (currbtn = Object(_findMatchesElement__WEBPACK_IMPORTED_MODULE_1__["default"])(e.target, 'a.next')) {
          // Next down
          e.preventDefault();
          var nextInd = _this.btnsDownNext.indexOf(currbtn) + 1;

          if (nextInd >= _this.N) {
            nextInd = 0;
          }

          Object(_showPagePart__WEBPACK_IMPORTED_MODULE_0__["default"])(_this.page, _this.partClass, nextInd);

          _this.slideChanged(nextInd);
        } else if (Object(_findMatchesElement__WEBPACK_IMPORTED_MODULE_1__["default"])(e.target, 'a.page-part-logo')) {
          // Logo
          Object(_showPagePart__WEBPACK_IMPORTED_MODULE_0__["default"])(_this.page, _this.partClass, 0);

          _this.slideChanged(0);
        }
      });
    }
  }, {
  ...
  return PagePartSlider;
}();

/* harmony default export */ __webpack_exports__["default"] = (PagePartSlider);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _findMatchesElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./findMatchesElement */ "./src/js/modules/findMatchesElement.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/*#__PURE__*/
function () {
  function Video(playBtnContainerSelector) {
  ...
  _createClass(Video, [{
    ...
    value: function prepare() {
      ...
      this.playBtnContainer.addEventListener('click', function (e) {
        if (!e.target) {
          return;
        }
        ...
        if (btn = Object(_findMatchesElement__WEBPACK_IMPORTED_MODULE_0__["default"])(e.target, '.play[data-url]')) {
          if (_this.ready) {
            _this.currBtnPlay = btn;

            for (var i = 0; i < _this.btnsPlay.length; i++) {
              if (btn == _this.btnsPlay[i]) {
                _this.currBtnPlayIndex = i;
                break;
              }
            }

            _this.elVideo.style.display = 'block';
            _this.overlay.style.display = "flex";
            var url = btn.dataset.url + '?enablejsapi=1&origin=' + window.location.origin;

            _this.player.loadVideoByUrl(url);
          }
        }
      });
      ...
      window.onYouTubeIframeAPIReady = function () {
        _this.player = new YT.Player('frame', {
          events: {
    ...
    key: "getWhatchedDuration",
    value: function getWhatchedDuration() {
      if (this.player && this.ready) {
...
/***/ "./src/js/modules/findMatchesElement.js":
/*!**********************************************!*\
  !*** ./src/js/modules/findMatchesElement.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var find = function find(el, pattern) {
...
/***/ "./src/js/modules/index_page/ItemSlider.js":
/*!*************************************************!*\
  !*** ./src/js/modules/index_page/ItemSlider.js ***!
  \*************************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function () {
  function ItemSlider(pagePart, itemClass, activeItemClass) {
    _classCallCheck(this, ItemSlider);

    this.activeItemClass = activeItemClass;
    this.slider = document.querySelector(".".concat(pagePart, "__slider"));
    this.sliderContent = document.querySelector(".".concat(pagePart, "__content-slider"));
    this.prev = document.querySelector(".".concat(pagePart, " .slick-prev"));
    this.next = document.querySelector(".".concat(pagePart, " .slick-next"));
    this.cards = this.slider.querySelectorAll("." + itemClass);
    this.cardsPos = _toConsumableArray(this.cards).map(function (c) {
      //Array.from(this.cards).map((c) => {//
      return c.offsetLeft;
    });
  ...
  _createClass(ItemSlider, [{
    ...
    value: function prepare() {
      ...
      this.prev.addEventListener('click', function () {
        _this.showSlide(--_this.currIndex);
      });
    ...
    value: function showSlide(index) {
      ...
      var show = function show(_card) {
        _card.classList.add(_this2.activeItemClass);
      };

      var hide = function hide(_card) {
        _card.classList.remove(_this2.activeItemClass);
      };
      ...
      this.currIndex = index; //let sh =  gethis.cards[this.currIndex].getBoundingClientRect().left-this.sliderContent.getBoundingClientRect().left;

      this.sliderContent.style.left = -this.cardsPos[this.currIndex] + "px"; //-sh + "px";//

      this.cards.forEach(function (_card, _i) {
        if (_this2.currIndex == _i) {
          show(_card);
        } else {
          hide(_card);
        }
    ...
    value: function startAutoplay(interval) {
      ...
      this.timer = setInterval(function () {
        _this3.showSlide(++_this3.currIndex);
      }, interval);
    }
  }, {
    key: "stopAutoplay",
...
/***/ "./src/js/modules/index_page/difference.js":
/*!*************************************************!*\
  !*** ./src/js/modules/index_page/difference.js ***!
  \*************************************************/
/*! exports provided: default */
...
var difference = function difference() {
  ...
  [offOld, offNew].forEach(function (diff) {
    var cards = diff.querySelectorAll('.officer__card-item.hidden-card'),
        cardAdd = diff.querySelector('.officer__card-item:last-child'),
        btnAdd = cardAdd.querySelector('.plus');
    var hiddenQty = cards.length;
...
/***/ "./src/js/modules/index_page/hanson.js":
/*!*********************************************!*\
  !*** ./src/js/modules/index_page/hanson.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var hanson = function hanson() {
  var el = document.querySelector('.hanson');
  var shown = false;
...
/* harmony default export */ __webpack_exports__["default"] = (hanson);

/***/ }),

/***/ "./src/js/modules/index_page/helpForm.js":
/*!***********************************************!*\
  !*** ./src/js/modules/index_page/helpForm.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _phonemask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../phonemask */ "./src/js/modules/phonemask.js");
/* harmony import */ var _preparePostData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./preparePostData */ "./src/js/modules/index_page/preparePostData.js");



var helpForm = function helpForm(selector) {
  ...
  Object(_phonemask__WEBPACK_IMPORTED_MODULE_0__["default"])(inputPhone, inputPhone.placeholder); // Post data

  Object(_preparePostData__WEBPACK_IMPORTED_MODULE_1__["default"])(selector, 'server.php');
};

/* harmony default export */ __webpack_exports__["default"] = (helpForm);

/***/ }),

/***/ "./src/js/modules/index_page/openModulesPage.js":
/*!******************************************************!*\
  !*** ./src/js/modules/index_page/openModulesPage.js ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var openModulesPage = function openModulesPage() {
  var plus = document.querySelector('.showup .plus');

  var open = function open(ind) {
    var pageName = 'index.html';
    var urlstr = window.location.href;
    urlstr = urlstr.substr(0, urlstr.lastIndexOf(pageName)) + 'modules.html';
    urlstr += "?module=".concat(ind + 1);
...
/* harmony default export */ __webpack_exports__["default"] = (openModulesPage);

/***/ }),

/***/ "./src/js/modules/index_page/preparePostData.js":
/*!******************************************************!*\
  !*** ./src/js/modules/index_page/preparePostData.js ***!
  \******************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var preparePostData = function preparePostData(selectorForm, url) {
...
/* harmony default export */ __webpack_exports__["default"] = (preparePostData);

/***/ }),

/***/ "./src/js/modules/index_page/timeForm.js":
/*!***********************************************!*\
  !*** ./src/js/modules/index_page/timeForm.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _preparePostData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./preparePostData */ "./src/js/modules/index_page/preparePostData.js");


var timeForm = function timeForm(selector) {
  var form = document.querySelector(selector),
  ...
  Object(_preparePostData__WEBPACK_IMPORTED_MODULE_0__["default"])(selector, 'server.php');
};

/* harmony default export */ __webpack_exports__["default"] = (timeForm);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var maskInputPhone = function maskInputPhone(_element, _mask) {
  ...
  var process = function process() {
    ...
    _element.value = matrix.replace(/./g, function (a) {
      var numberPlace = /[_\d]/.test(a);
      var maskNumber = /[\d]/.test(a);
      var ch = "";
...
/* harmony default export */ __webpack_exports__["default"] = (maskInputPhone);

/***/ }),

/***/ "./src/js/modules/polyfills/NodeList_SymbolItrerator.js":
/*!**************************************************************!*\
  !*** ./src/js/modules/polyfills/NodeList_SymbolItrerator.js ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ "./src/js/modules/prepareModalDiaolog.js":
/*!***********************************************!*\
  !*** ./src/js/modules/prepareModalDiaolog.js ***!
  \***********************************************/
/*! exports provided: default */
...
var prepareModalDiaolog = function prepareModalDiaolog() {
...
/* harmony default export */ __webpack_exports__["default"] = (prepareModalDiaolog);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var showPagePart = function showPagePart(page, _partClass, ind) {
  var pageParts = page.querySelectorAll("." + _partClass);
  pageParts.forEach(function (_p, i) {
    if (ind == i) {
...
/* harmony import */ var _modules_polyfills_NodeList_SymbolItrerator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/polyfills/NodeList_SymbolItrerator */ "./src/js/modules/polyfills/NodeList_SymbolItrerator.js");
/* harmony import */ var _modules_polyfills_NodeList_SymbolItrerator__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_polyfills_NodeList_SymbolItrerator__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _modules_prepareModalDiaolog__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/prepareModalDiaolog */ "./src/js/modules/prepareModalDiaolog.js");
/* harmony import */ var _modules_PagePartSlider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/PagePartSlider */ "./src/js/modules/PagePartSlider.js");
/* harmony import */ var _modules_Video__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/Video */ "./src/js/modules/Video.js");
/* harmony import */ var _modules_index_page_ItemSlider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/index_page/ItemSlider */ "./src/js/modules/index_page/ItemSlider.js");
/* harmony import */ var _modules_index_page_openModulesPage__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/index_page/openModulesPage */ "./src/js/modules/index_page/openModulesPage.js");
/* harmony import */ var _modules_index_page_difference__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/index_page/difference */ "./src/js/modules/index_page/difference.js");
/* harmony import */ var _modules_index_page_hanson__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/index_page/hanson */ "./src/js/modules/index_page/hanson.js");
/* harmony import */ var _modules_index_page_helpForm__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/index_page/helpForm */ "./src/js/modules/index_page/helpForm.js");
/* harmony import */ var _modules_index_page_timeForm__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/index_page/timeForm */ "./src/js/modules/index_page/timeForm.js");
 // Polyfills
...
document.addEventListener('DOMContentLoaded', function () {
  Object(_modules_prepareModalDiaolog__WEBPACK_IMPORTED_MODULE_6__["default"])();
  var pagePartSlider = new _modules_PagePartSlider__WEBPACK_IMPORTED_MODULE_7__["default"]('page', 'page-part');

  pagePartSlider.onSlideChanged = function (ind) {
    if (ind == 2) {
      Object(_modules_index_page_hanson__WEBPACK_IMPORTED_MODULE_12__["default"])();
    }
  };

  var video = new _modules_Video__WEBPACK_IMPORTED_MODULE_8__["default"]('.showup__wrapper');
  video.prepare();
  var showupSlider = new _modules_index_page_ItemSlider__WEBPACK_IMPORTED_MODULE_9__["default"]('showup', 'card', 'card-active');
  showupSlider.showSlide(0);
  var modulesSlider = new _modules_index_page_ItemSlider__WEBPACK_IMPORTED_MODULE_9__["default"]('modules', 'card', 'card-active');
  modulesSlider.showSlide(0);
  modulesSlider.startAutoplay(4000);
  var feedSlider = new _modules_index_page_ItemSlider__WEBPACK_IMPORTED_MODULE_9__["default"]('feed', 'feed__item', 'feed__item-active');
  feedSlider.showSlide(0);
  Object(_modules_index_page_openModulesPage__WEBPACK_IMPORTED_MODULE_10__["default"])();
  Object(_modules_index_page_difference__WEBPACK_IMPORTED_MODULE_11__["default"])();
  Object(_modules_index_page_helpForm__WEBPACK_IMPORTED_MODULE_13__["default"])('.join .form');
  Object(_modules_index_page_timeForm__WEBPACK_IMPORTED_MODULE_14__["default"])('.schedule .form');
});
