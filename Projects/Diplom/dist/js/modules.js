...
/* harmony import */ var _modules_polyfills_number_isInteger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/polyfills/number_isInteger */ "./src/js/modules/polyfills/number_isInteger.js");
/* harmony import */ var _modules_polyfills_number_isInteger__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_polyfills_number_isInteger__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var es6_promise__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! es6-promise */ "./node_modules/es6-promise/dist/es6-promise.js");
...
/* harmony import */ var _modules_polyfills_array_includes__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/polyfills/array_includes */ "./src/js/modules/polyfills/array_includes.js");
/* harmony import */ var _modules_polyfills_array_includes__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_modules_polyfills_array_includes__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _modules_polyfills_NodeList_SymbolItrerator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/polyfills/NodeList_SymbolItrerator */ "./src/js/modules/polyfills/NodeList_SymbolItrerator.js");
/* harmony import */ var _modules_polyfills_NodeList_SymbolItrerator__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_modules_polyfills_NodeList_SymbolItrerator__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _modules_prepareModalDiaolog__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/prepareModalDiaolog */ "./src/js/modules/prepareModalDiaolog.js");
/* harmony import */ var _modules_Video__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/Video */ "./src/js/modules/Video.js");
/* harmony import */ var _modules_modules_page_videoAction__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/modules_page/videoAction */ "./src/js/modules/modules_page/videoAction.js");
/* harmony import */ var _modules_PagePartSlider__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/PagePartSlider */ "./src/js/modules/PagePartSlider.js");
/* harmony import */ var _modules_modules_page_ModulesPagePartSlider__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/modules_page/ModulesPagePartSlider */ "./src/js/modules/modules_page/ModulesPagePartSlider.js");
/* harmony import */ var _modules_modules_page_accordeon__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/modules_page/accordeon */ "./src/js/modules/modules_page/accordeon.js");
/* harmony import */ var _modules_modules_page_prepareDownloadFile__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/modules_page/prepareDownloadFile */ "./src/js/modules/modules_page/prepareDownloadFile.js");
 // Polyfills
...
document.addEventListener('DOMContentLoaded', function () {
  Object(_modules_prepareModalDiaolog__WEBPACK_IMPORTED_MODULE_9__["default"])();
  var video = new _modules_Video__WEBPACK_IMPORTED_MODULE_10__["default"]('.moduleapp');
  video.prepare();
  Object(_modules_modules_page_videoAction__WEBPACK_IMPORTED_MODULE_11__["default"])(video); // Сделать доступ ко второму видео только после просмотра 95% видео

  new _modules_PagePartSlider__WEBPACK_IMPORTED_MODULE_12__["default"]('moduleapp', 'module');
  var modulePagePartSlider = new _modules_modules_page_ModulesPagePartSlider__WEBPACK_IMPORTED_MODULE_13__["default"]('moduleapp', 'module'); // Открыть страницу на соответствующе слайде
  ...
  Object(_modules_modules_page_accordeon__WEBPACK_IMPORTED_MODULE_14__["default"])();
  Object(_modules_modules_page_prepareDownloadFile__WEBPACK_IMPORTED_MODULE_15__["default"])();
});
...
/***/ "./src/js/modules/modules_page/ModulesPagePartSlider.js":
/*!**************************************************************!*\
  !*** ./src/js/modules/modules_page/ModulesPagePartSlider.js ***!
  \**************************************************************/
/*! exports provided: default */
...
var ModulesPagePartSlider =
/*#__PURE__*/
function () {
  function ModulesPagePartSlider(_containerClass, _partClass) {
    _classCallCheck(this, ModulesPagePartSlider);

    this.partClass = _partClass;
    this.page = document.querySelector(".".concat(_containerClass));
    this.btnsPrev = _toConsumableArray(this.page.querySelectorAll('.module__info-controls .prev a.prevmodule')); //Array.from(this.page.querySelectorAll('.module__info-controls .prev a.prevmodule'));//

    this.btnsNext = _toConsumableArray(this.page.querySelectorAll('.module__info-controls .next a.nextmodule')); //Array.from(this.page.querySelectorAll('.module__info-controls .next a.nextmodule'));//
  ...
  _createClass(ModulesPagePartSlider, [{
    key: "prepare",
    value: function prepare() {
      var _this = this;
      ...
      this.page.addEventListener('click', function (e) {
        ...
        if (e.target && (currbtn = Object(_findMatchesElement__WEBPACK_IMPORTED_MODULE_1__["default"])(e.target, 'a.nextmodule, a.prevmodule'))) {
          e.preventDefault();
          var nextInd = 0;

          if (_this.btnsNext.includes(currbtn)) {
            nextInd = _this.btnsNext.indexOf(currbtn) + 1;

            if (nextInd >= _this.N) {
              nextInd = 0;
            }
          } else if (_this.btnsPrev.includes(currbtn)) {
            nextInd = _this.btnsPrev.indexOf(currbtn) - 1;
    ...
    key: "openSlide",
    value: function openSlide(ind) {
      Object(_showPagePart__WEBPACK_IMPORTED_MODULE_0__["default"])(this.page, this.partClass, ind);
    }
  }]);

  return ModulesPagePartSlider;
}();

/* harmony default export */ __webpack_exports__["default"] = (ModulesPagePartSlider);

/***/ }),

/***/ "./src/js/modules/modules_page/accordeon.js":
/*!**************************************************!*\
  !*** ./src/js/modules/modules_page/accordeon.js ***!
  \**************************************************/
/*! exports provided: default */
...
var accordeon = function accordeon() {
  var app = document.querySelector('.moduleapp');
  app.addEventListener('click', function (e) {
    ...
    if (plus = Object(_findMatchesElement__WEBPACK_IMPORTED_MODULE_0__["default"])(e.target, '.module__info-show .plus')) {
      var elComment = plus.parentNode.parentNode.querySelector('.module__info-comment'); //plus.parentElement.parentElement.querySelector('.module__info-comment');
...
/***/ "./src/js/modules/modules_page/prepareDownloadFile.js":
/*!************************************************************!*\
  !*** ./src/js/modules/modules_page/prepareDownloadFile.js ***!
  \************************************************************/
/*! exports provided: default */
...
var prepareDownloadFile = function prepareDownloadFile() {
  var app = document.querySelector('.moduleapp');
  app.addEventListener('click', function (e) {
    if (!e.target) {
      return;
    ...
    if (download = Object(_findMatchesElement__WEBPACK_IMPORTED_MODULE_0__["default"])(e.target, 'div.download[data-filename]')) {
      var filename = download.dataset.filename;
...
/* harmony default export */ __webpack_exports__["default"] = (prepareDownloadFile);

/***/ }),

/***/ "./src/js/modules/modules_page/videoAction.js":
/*!****************************************************!*\
  !*** ./src/js/modules/modules_page/videoAction.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var videoAction = function videoAction(video) {
  video.btnClose.addEventListener('click', function () {
    var nextBtn,
        currInd = video.currBtnPlayIndex;
    ...
    if (nextBtn && nextBtn.classList.contains('blocked')) {
      var pcWatched = video.getWhatchedDuration() / video.getVideoDuration() * 100;

      if (!isNaN(pcWatched) && pcWatched > 95) {
        nextBtn.innerHTML = video.btnsPlay[currInd].innerHTML;
        nextBtn.classList.remove('blocked');
        var v2 = nextBtn.parentNode; //nextBtn.parentElement;
...
/* harmony default export */ __webpack_exports__["default"] = (videoAction);
...
/***/ "./src/js/modules/polyfills/array_includes.js":
/*!****************************************************!*\
  !*** ./src/js/modules/polyfills/array_includes.js ***!
  \****************************************************/
/*! no static exports found */
...
/***/ "./src/js/modules/polyfills/number_isInteger.js":
/*!******************************************************!*\
  !*** ./src/js/modules/polyfills/number_isInteger.js ***!
  \******************************************************/
/*! no static exports found */
