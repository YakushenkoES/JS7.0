...
/* harmony import */ var _modules_modulesSlider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modulesSlider */ "./src/js/modules/modulesSlider.js");
...
document.addEventListener('DOMContentLoaded', function () {
  Object(_modules_mainSlider__WEBPACK_IMPORTED_MODULE_3__["default"])('moduleapp', 'module');
  Object(_modules_modulesSlider__WEBPACK_IMPORTED_MODULE_4__["default"])('moduleapp', 'module');
});
...
function mainSlider(_containerClass, _partClass) {
  var page = document.querySelector(".".concat(_containerClass)),
      btnsNext = Array.from(page.querySelectorAll('a.next')),
      pageParts = Array.from(page.children),
      logos = page.querySelectorAll(".".concat(_partClass, " .sidecontrol > a:first-child")),
      N = pageParts.length; // Нижние кнопки перехода на следующую часть страницы
...
/***/ "./src/js/modules/modulesSlider.js":
/*!*****************************************!*\
  !*** ./src/js/modules/modulesSlider.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (modulesSlider);
